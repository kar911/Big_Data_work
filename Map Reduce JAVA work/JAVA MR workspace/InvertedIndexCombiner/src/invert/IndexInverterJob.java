...
public class IndexInverterJob extends Configured implements Tool {
	...
	public static enum COUNTER{
		...
		public void count__t(){
			count++;
		}
	}
	
	public static class WordCountPartitioner
	extends Partitioner<Text, IntWritable> {public int getPartition(Text key,
	IntWritable value,
	int numReduceTasks) {
		//The partition phase takes place after 
		//the Map phase and before the Reduce phase.
	...
	* value.get()) % numReduceTasks;
	...
	public static class IndexInverterCombiner extends
	Reducer<Text,Text, Text, Text> {
private Text outputValue = new Text();
// after the shuffel and sort in reduce get k2 and Listof<V2>
//TODO
